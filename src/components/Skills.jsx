...
const techStack = [
  ...
  { name: "VISUAL BASIC", role: "Legacy Continuity", color: "#0052AD", icon: <svg viewBox="0 0 24 24" fill="currentColor"><path d="M12 0l-12 12 12 12 12-12-12-12zm-4.305 16.5h-1.695v-9h1.695v9zm10.305-4.5c0 1.654-1.346 3-3 3h-4v-6h4c1.654 0 3 1.346 3 3z"/></svg> }
];
