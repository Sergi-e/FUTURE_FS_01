      ...
      <div className="contact-container">
        ...
        <div className="contact-methods">
          <div className="magnetic-button-wrapper">
            <a ref={buttonRef} href="https://mail.google.com/mail/?view=cm&fs=1&to=ishserge16@gmail.com" target="_blank" rel="noopener noreferrer" className="magnetic-button gmail-link">
