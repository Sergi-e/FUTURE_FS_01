...
export default function Contact() {
  ...
  useEffect(() => {
    // If form is visible, we optionally pause physics if wanted, but it's simpler to keep them running for the mailto button above it.
    ...
    <section className="contact" id="contact">
      <div className="contact-container">
        ...
        <div className="contact-methods">
          ...
          {/* Form Toggle Link / Form Container */}
          <div style={{ marginTop: '20px', textAlign: 'center', width: '100%', maxWidth: '500px' }}>
            {!showForm ? (
              <button 
              ...
              >
                For more inquiries or booking, fill out the contact form
              </button>
            ) : (
              <form onSubmit={handleSubmit} className="inpage-contact-form" style={{ display: 'flex', flexDirection: 'column', gap: '15px', background: '#111', padding: '30px', borderRadius: '12px', width: '100%', textAlign: 'left', marginTop: '20px' }}>
                ...
                <div style={{display: 'flex', justifyContent: 'space-between', alignItems: 'center'}}>
                  ...
                  <button type="button" onClick={() => setShowForm(false)} style={{background: 'transparent', color: '#ff4a4a', border: 'none', cursor: 'pointer', fontSize: '0.9rem', fontFamily: 'var(--font-sans)'}}>CANCEL</button>
                </div>
