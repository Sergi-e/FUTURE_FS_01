      ...
      if (!admin) {
        ...
        if (count === 0) {
          ...
          if (projectCount === 0) {
            ...
            await Project.create({ id: pid1, title: 'CLIMATE CHANGE IMPACT', subtitle: 'A 2025 field research project on marine ecosystems. I monitored biodiversity, collected environmental data, and used ArcGIS for spatial analysis and mapping, turning raw field observations into clear data visualizations. Where conservation meets code.', year: '2025', link: 'https://arcg.is/09v5GS1', mediaType: 'video', mediaPath: '/assets/kivu.mp4' });
            await Project.create({ id: pid2, title: 'BE THE LIGHT WEBSITE', subtitle: 'A community platform built for Be The Light, a grassroots organization dedicated to supporting families in hardship and empowering youth across Rwanda. The site brings together the organization\'s story, mission, goals, and member community in one place, with a blog and a call to action for people to get involved. Built with a warm, purpose-driven design that reflects the heart of the movement.', year: '2025', link: 'https://bethe-light-hub.lovable.app/', mediaType: 'image', mediaPath: '/assets/bethelight.png' });
          }
